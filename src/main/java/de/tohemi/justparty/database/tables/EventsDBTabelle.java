...
/**
 * Created by Micha Piertzik on 07.12.2015.
 */
public class EventsDBTabelle {
    ...
    public static final String COLUMN_FACEBOOK = "facebook_link";
    public static final String COLUMN_WISHLIST = "wishlist_link";
